...
from docx.lxml import elm_ns_cls_lookup
...
def parse_xml(xml: str | bytes, elm_hint: type[ELM_T] = OxmlElement) -> ELM_T:
...
def register_element_cls(tag: str, cls: type[OxmlElement]):
