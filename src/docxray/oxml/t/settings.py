...
from docxray.oxml.t.shared import CT_Language
from docxray.oxml.t.st.enums import SE_WML_COLOR_SCHEME_INDEX
from docxray.oxml.t.st.wml import ST_WmlColorSchemeIndex
